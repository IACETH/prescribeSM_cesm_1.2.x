...
!KO
    allocate(pps%u10_clm_u(beg:end))
    allocate(pps%u10_clm_r(beg:end))
!KO
...
!KO
    pps%u10_clm_u(beg:end) = nan
    pps%u10_clm_r(beg:end) = nan
!KO
    pps%va(beg:end) = nan
    pps%fv(beg:end) = nan
...
!KO
    allocate(pes%nws_heatindex_ref2m(beg:end))
    allocate(pes%appar_temp_ref2m(beg:end))
    allocate(pes%swbgt_ref2m(beg:end))
    allocate(pes%humidex_ref2m(beg:end))
    allocate(pes%discomf_index_ref2m(beg:end))
    allocate(pes%nws_heatindex_ref2m_r(beg:end))
    allocate(pes%appar_temp_ref2m_r(beg:end))
    allocate(pes%swbgt_ref2m_r(beg:end))
    allocate(pes%humidex_ref2m_r(beg:end))
    allocate(pes%discomf_index_ref2m_r(beg:end))
    allocate(pes%nws_heatindex_ref2m_u(beg:end))
    allocate(pes%appar_temp_ref2m_u(beg:end))
    allocate(pes%swbgt_ref2m_u(beg:end))
    allocate(pes%humidex_ref2m_u(beg:end))
    allocate(pes%discomf_index_ref2m_u(beg:end))
!KO
...
!KO
    pes%nws_heatindex_ref2m(beg:end) = nan
    pes%appar_temp_ref2m(beg:end) = nan
    pes%swbgt_ref2m(beg:end) = nan
    pes%humidex_ref2m(beg:end) = nan
    pes%discomf_index_ref2m(beg:end) = nan
    pes%nws_heatindex_ref2m_r(beg:end) = nan
    pes%appar_temp_ref2m_r(beg:end) = nan
    pes%swbgt_ref2m_r(beg:end) = nan
    pes%humidex_ref2m_r(beg:end) = nan
    pes%discomf_index_ref2m_r(beg:end) = nan
    pes%nws_heatindex_ref2m_u(beg:end) = nan
    pes%appar_temp_ref2m_u(beg:end) = nan
    pes%swbgt_ref2m_u(beg:end) = nan
    pes%humidex_ref2m_u(beg:end) = nan
    pes%discomf_index_ref2m_u(beg:end) = nan
!KO
