...
!KO
   ...
   real(r8), pointer :: swbgt_ref2m(:)           ! 2 m height simplified wet bulb global temperature (-)
   real(r8), pointer :: humidex_ref2m(:)         ! 2 m height humidex (-)
   ...
   real(r8), pointer :: swbgt_ref2m_r(:)         ! Rural 2 m height simplified wet bulb global temperature (-)
   real(r8), pointer :: humidex_ref2m_r(:)       ! Rural 2 m height humidex (-)
