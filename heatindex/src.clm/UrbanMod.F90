...
!KO
    ...
    real(r8), pointer :: u10_clm_u(:)         ! urban 10-m wind (m/s)
!KO
!
! local pointers to original implicit out arguments
!
...
!KO
    ...
    real(r8), pointer :: nws_heatindex_ref2m_u(:) ! Urban 2 m height NWS heat index (degrees F)
    real(r8), pointer :: appar_temp_ref2m_u(:)    ! Urban 2 m height apparent temperature (degrees C)
    real(r8), pointer :: swbgt_ref2m_u(:)         ! Urban 2 m height simplified wet bulb global temperature (degrees C)
    real(r8), pointer :: humidex_ref2m_u(:)       ! Urban 2 m height humidex (degrees C)
    real(r8), pointer :: discomf_index_ref2m_u(:) ! Urban 2 m height discomfort index (degrees C)
!KO
!
!
! !OTHER LOCAL VARIABLES
...
!KO
    ...
    u10_clm_u             => clm3%g%l%c%p%pps%u10_clm_u
    ...
    nws_heatindex_ref2m_u => clm3%g%l%c%p%pes%nws_heatindex_ref2m_u
    appar_temp_ref2m_u    => clm3%g%l%c%p%pes%appar_temp_ref2m_u
    swbgt_ref2m_u         => clm3%g%l%c%p%pes%swbgt_ref2m_u
    humidex_ref2m_u       => clm3%g%l%c%p%pes%humidex_ref2m_u
    discomf_index_ref2m_u => clm3%g%l%c%p%pes%discomf_index_ref2m_u
!KO
...
!KO
       ...
       nws_heatindex_ref2m_u(p) = nws_heatindex_ref2m(p)
