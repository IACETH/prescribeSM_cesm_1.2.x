...
!KO
    call hist_addfld1d (fname='HEAT_INDEX', units='F',  &
         avgflag='A', long_name='NWS Heat Index', &
         ptr_pft=clm3%g%l%c%p%pes%nws_heatindex_ref2m)

    call hist_addfld1d (fname='HEAT_INDEX_U', units='F',  &
         avgflag='A', long_name='Urban NWS Heat Index', &
         ptr_pft=clm3%g%l%c%p%pes%nws_heatindex_ref2m_u, set_nourb=spval)

    call hist_addfld1d (fname='HEAT_INDEX_R', units='F',  &
         avgflag='A', long_name='Rural NWS Heat Index', &
         ptr_pft=clm3%g%l%c%p%pes%nws_heatindex_ref2m_r, set_spec=spval)

    call hist_addfld1d (fname='APPARENT_TEMP', units='C',  &
         avgflag='A', long_name='Apparent Temperature', &
         ptr_pft=clm3%g%l%c%p%pes%appar_temp_ref2m)

    call hist_addfld1d (fname='APPARENT_TEMP_U', units='C',  &
         avgflag='A', long_name='Urban Apparent Temperature', &
         ptr_pft=clm3%g%l%c%p%pes%appar_temp_ref2m_u, set_nourb=spval)

    call hist_addfld1d (fname='APPARENT_TEMP_R', units='C',  &
         avgflag='A', long_name='Rural Apparent Temperature', &
         ptr_pft=clm3%g%l%c%p%pes%appar_temp_ref2m_r, set_spec=spval)

    call hist_addfld1d (fname='SWBGT', units='C',  &
         avgflag='A', long_name='Simplified Wet Bulb Globe Temperature', &
         ptr_pft=clm3%g%l%c%p%pes%swbgt_ref2m)

    call hist_addfld1d (fname='SWBGT_U', units='C',  &
         avgflag='A', long_name='Urban Simplified Wet Bulb Globe Temperature', &
         ptr_pft=clm3%g%l%c%p%pes%swbgt_ref2m_u, set_nourb=spval)

    call hist_addfld1d (fname='SWBGT_R', units='C',  &
         avgflag='A', long_name='Rural Simplified Wet Bulb Globe Temperature', &
         ptr_pft=clm3%g%l%c%p%pes%swbgt_ref2m_r, set_spec=spval)

    call hist_addfld1d (fname='HUMIDEX', units='C',  &
         avgflag='A', long_name='Humidex', &
         ptr_pft=clm3%g%l%c%p%pes%humidex_ref2m)

    call hist_addfld1d (fname='HUMIDEX_U', units='C',  &
         avgflag='A', long_name='Urban Humidex', &
         ptr_pft=clm3%g%l%c%p%pes%humidex_ref2m_u, set_nourb=spval)

    call hist_addfld1d (fname='HUMIDEX_R', units='C',  &
         avgflag='A', long_name='Rural Humidex', &
         ptr_pft=clm3%g%l%c%p%pes%humidex_ref2m_r, set_spec=spval)

    call hist_addfld1d (fname='DISCOMFORT_INDEX', units='C',  &
         avgflag='A', long_name='Discomfort Index', &
         ptr_pft=clm3%g%l%c%p%pes%discomf_index_ref2m)

    call hist_addfld1d (fname='DISCOMFORT_INDEX_U', units='C',  &
         avgflag='A', long_name='Urban Discomfort Index', &
         ptr_pft=clm3%g%l%c%p%pes%discomf_index_ref2m_u, set_nourb=spval)

    call hist_addfld1d (fname='DISCOMFORT_INDEX_R', units='C',  &
         avgflag='A', long_name='Rural Discomfort Index', &
         ptr_pft=clm3%g%l%c%p%pes%discomf_index_ref2m_r, set_spec=spval)
!KO
...
!KO
    call hist_addfld1d (fname='U10_U', units='m/s', &
         ...
         ptr_pft=clm3%g%l%c%p%pps%u10_clm_u, set_nourb=spval)

    call hist_addfld1d (fname='U10_R', units='m/s', &
         avgflag='A', long_name='Rural 10-m wind', &
         ptr_pft=clm3%g%l%c%p%pps%u10_clm_r, set_spec=spval)
!KO
