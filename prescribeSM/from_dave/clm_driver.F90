...
!DML
  use STATICEcosysDynMod  , only : interpMonthlySoil
!DML
...
!DML
  ! ============================================================================
  ! interpolate monthly soil moisture data, and read in new monthly data if need be.
  ! ============================================================================
     call interpMonthlySoil()
!DML
...
!                       filter(nc)%num_nolakep, filter(nc)%nolakep, &
!                       doalb)
     call EcosystemDyn(begc, endc, filter(nc)%num_nolakec, filter(nc)%nolakec,&
